...
class NewbizRequestController extends Controller
{
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'best_desc_property' => 'required|string|max:255',
            'estimated_square_footage' => 'required|integer|min:0',
            'number_of_bedrooms' => 'required|integer|min:0',
            'when_planning_to_rent' => 'required|string|max:255',
            'plans_with_property' => 'required|string|max:255',
            'considering_selling' => 'required|string|max:255',
            'rent_amount_in_mind' => 'required|string|max:255',
            'worked_with_property_manager' => 'required|string|max:255',
            'where_heard_about_orca' => 'required|string|max:255',
